...
static TeUART_Return UART_Select(UART_st* uart)
{
...
static TeUART_Return UART_Baud_Rate_Select(UART_st* uart)
{
...
static TeUART_Return UART_Datasize_Select(UART_st* uart)
{
...
static TeUART_Return UART_Mode_Select(UART_st* uart)
{
	switch(uart->mode)
	{
		case UART_RX:
...
static TeUART_Return UART_MSB_Select(UART_st* uart)
{
